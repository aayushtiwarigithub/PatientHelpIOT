...
import { lightningChart, ChartXY, AxisScrollStrategies, Themes, Point } from '@arction/lcjs';
...
export class EcgComponent implements OnChanges, OnDestroy, AfterViewInit {
  chart: ChartXY;
  chartId: number;
